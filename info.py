...
BOT_TOKEN = environ.get('BOT_TOKEN', "7453674332:AAGwl2taVw81Osw09ZDQC-OY6CAsQk99OAU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6914788581 7687156159').split()]
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7375753854 6914788581').split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Morning006') # owner username without @
